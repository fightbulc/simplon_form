<?php
  ...
  class Email extends AbstractRule
  {
    public function run()
    {
      ...
      if(! $this->_validateEmailAddress($elementValue))
      {
    ...
    protected function _validateEmailAddress($email, $options = array())
    {
      #
      ...
      {
        $email = $this->_emailStripComments($outer_comment, $email, "(x)");
      }
      ...
      if($options['allow_comments'])
      {
        $bits['local'] = $this->_emailStripComments($comment, $bits['local']);
        $bits['domain'] = $this->_emailStripComments($comment, $bits['domain']);
      }
    ...
    protected function _emailStripComments($comment, $email, $replace = '')
    {
      while(1)
      {
